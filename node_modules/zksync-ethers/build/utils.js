...
const IZkSync_json_1 = __importDefault(require("../abi/IZkSync.json"));
...
const IL1Bridge_json_1 = __importDefault(require("../abi/IL1Bridge.json"));
 ...
 * @constant
 */
exports.ZKSYNC_MAIN_ABI = new ethers_1.ethers.Interface(IZkSync_json_1.default);
/**
 ...
 * @constant
 */
exports.L1_BRIDGE_ABI = new ethers_1.ethers.Interface(IL1Bridge_json_1.default);
/**
...
function getHashedL2ToL1Msg(sender, msg, txNumberInBlock) {
    const encodedMsg = new Uint8Array([
        0, // l2ShardId
        1, // isService
        ...ethers_1.ethers.getBytes(ethers_1.ethers.zeroPadValue(ethers_1.ethers.toBeHex(txNumberInBlock), 2)),
...
function applyL1ToL2Alias(address) {
    return ethers_1.ethers.zeroPadValue(ethers_1.ethers.toBeHex((BigInt(address) + BigInt(exports.L1_TO_L2_ALIAS_OFFSET)) % ADDRESS_MODULO), 20);
}
...
function undoL1ToL2Alias(address) {
    ...
    return ethers_1.ethers.zeroPadValue(ethers_1.ethers.toBeHex(result), 20);
}
