...
const populateTransactionECDSA = async (tx, secret, provider) => {
    ...
    populatedTx.gasPrice ?? (populatedTx.gasPrice = await provider.getGasPrice());
    ...
    if (populatedTx.from) {
        ...
        if (isContractAccount) {
            ...
            populatedTx.gasLimit ?? (populatedTx.gasLimit = await provider.estimateGas({
                ...populatedTx,
    ...
    populatedTx.gasLimit ?? (populatedTx.gasLimit = await provider.estimateGas(populatedTx));
