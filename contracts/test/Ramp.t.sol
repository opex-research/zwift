...
import "../lib/openzeppelin-contracts/contracts/token/ERC20/ERC20.sol"; // Needed for the MockERC20 token
import {DataTypes} from "../paypal/datatypes/DataTypes.sol";
...
contract RampTest is Test {
    ...
    function testQueueAndExecuteCancellation() public {
        ...
        bytes32 cancellationId = ramp.getCancellationId(
            0,
            user,
            block.timestamp
        );
        ...
        Ramp.Cancellation memory cancellation = ramp.cancellations(
            cancellationId
        );
